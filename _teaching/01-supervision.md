...
#### {% assign student = student | plus: 1 -%}{{- student -}}.&nbsp;Mr. {% include person.liquid person="zeng_jiazheng" no_links=true %}
...
##### {% assign student = student | plus: 1 -%}{{- student -}}.&nbsp;Ms. {% include person.liquid person="lin_shan" no_links=true %}
- Topic: Crossover for the Traveling Salesperson Problem
- Duration: 2014
- Supervisor: {% include person.liquid person="weise_thomas" %}

##### {% assign student = student | plus: 1 -%}{{- student -}}.&nbsp;Mr. {% include person.liquid person="chen_wenxiang" no_links=true %}
