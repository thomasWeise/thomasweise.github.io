...
- Mr. {{site.data.people.zhao_rui}}
    ...
    + Supervisors: {{site.data.people.tan_ming}}, {{site.data.people.weise_thomas}}
    + Duration: 2022-2025
- Mr. {{site.data.people.liang_tianyu}}
    + Type: Master's Student
    + Topic: Traveling Salesperson Problem, Frequency Fitness Assignment
    + Supervisor: {{site.data.people.weise_thomas}}
    + Duration: 2021-2024
- Mr. {{site.data.people.sun_pengpeng}}
    + Type: Master's Student
    + Topic: Deep Learning
    + Supervisors: {{site.data.people.wu_zhize}}, {{site.data.people.weise_thomas}}
    + Duration: 2021-2024
- Mr. {{site.data.people.liu_zhiyang}}
    + Type: Master's Student
    + Topic: Deep Learning, Detection of Personal Protective Equipment
    + Supervisors: {{site.data.people.wu_zhize}}, {{site.data.people.weise_thomas}}
    + Duration: 2020-2023
- Ms. {{site.data.people.ran_shuoyi}}
    + Type: Master's Student
...
### External Students
- Mr. {{site.data.people.cosson_raphael}}
    + Type: Master's Student
    ...
    + Main Supervisor: {{site.data.people.doerr_carola}}
    + Co-Supervisor: {{site.data.people.weise_thomas}}
...
- Ms. {{site.data.people.lin_shan}}
    ...
    + Duration: 2014
    + Supervisor: {{site.data.people.weise_thomas}}
- Mr. {{site.data.people.chen_wenxiang}}
...
- Mr. {{site.data.people.xu_dan}}
    + Topic: Traveling Salesperson Problem
    + Duration: 2015-2016
- Mr. {{site.data.people.ouyang_jin}}
    + Topic: Traveling Salesperson Problem
    + Duration: 2012-2013
...
- Mr. {{site.data.people.podlich_alexander}}
    + Topic: Intelligent Control of Swap Body-based Logistics on Road and Rail
    + Duration: 2008–2009
    + Supervisor: {{site.data.people.weise_thomas}}
- Mr. {{site.data.people.niemczyk_stefan}}
...
- Mr. {{site.data.people.voigtmann_christian}}
