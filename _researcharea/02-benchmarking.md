...
Maybe we even have an algorithm that can solve both TSPs and Quadratic Assignment Problems&nbsp;({%- include taglink.liquid tag="QAP" tag_text="QAPs" -%}), but pays for this with slightly lower solution quality or longer [runtime]({%- post_url 2017-02-16-measuring-runtime-of-optimization-algorithms -%}).
