...
Packing is a research field of {% include taglink.liquid tag="or" tag_text="Operations Research" %} and very closely related to {% include taglink.liquid tag="logistics" -%}.
