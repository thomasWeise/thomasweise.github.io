...
tags: ["moptipy", "software", "Python", "benchmarking", "metaheuristics", "RLS", "local search"]
---
...
[`moptipy`](/moptipy)&nbsp;is structured with performance, ease-of-use, and generality in mind, but also based on an educational and research perspective.
