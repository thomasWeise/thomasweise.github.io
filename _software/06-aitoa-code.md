---
title: "aitoa-code: Metaheuristic Optimization with Java"
permalink: /aitoa-code
read_time: false
toc: true
author_profile: true
date: 2026-02-03
...
Check [moptipy](/moptipy) for a similar package for Python.**
...
1. [aitoa.pdf](/aitoa/aitoa.pdf), in the [PDF](/aitoa/aitoa.pdf) format for reading on the computer and/or printing (but please don't print this, save paper),
2. [aitoa.html](/aitoa/aitoa.html), in the [HTML5](/aitoa/aitoa.html) format for reading in the browser on any device,
3. [aitoa.epub](/aitoa/aitoa.epub), in the [EPUB3](/aitoa/aitoa.epub) format for reading on mobile phones or other hand-held devices, and
4. [aitoa.azw3](/aitoa/aitoa.azw3), in the [AZW3](/aitoa/aitoa.azw3) format for reading on Kindle and similar devices.

## 2. How to Use

### 2.1. Installation
The source code is provided at [GitHub](http://github.com/thomasWeise/aitoa-code) as a [Maven](https://maven.apache.org) project for Java&nbsp;1.8 along with settings for the [Eclipse](http://www.eclipse.org) developer environment.
...
How to run experiments with this code is discussed and shown in the book "[An Introduction to Optimization Algorithms](/aitoa)".
...
## 3. License
The copyright holder of this package is Prof. Dr. [Thomas Weise](https://thomasweise.github.io) (see Contact).
