...
My [research area](/research/areas) is {% include taglink.liquid tag="metaheuristics" tag_text="metaheuristic" %} {% include taglink.liquid tag="optimization" %} and {% include taglink.liquid tag="or" tag_text="Operations Research" %}.
