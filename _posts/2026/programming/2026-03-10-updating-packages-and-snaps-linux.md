...
This means that, whenever I shut down my computer, I run a little {% include taglink.liquid tag="bash" %} script [`update.sh`](https://thomasweise.github.io/scripts/linux/update.sh) that updates all installed packages, both `deb` and `snap` packages.
