...
Here I provide the little {% include taglink.liquid tag="bash" %} script [`findNonASCIIchars.sh`](https://thomasweise.github.io/scripts/linux/findNonASCIIchars.sh), which does this in the {% include taglink.liquid tag="linux" %} terminal.
...
[Here](https://thomasweise.github.io/scripts/linux/findNonASCIIchars.sh) you can download this script and the complete collection of my personal scripts is available [here](http://thomasweise.github.io/scripts/scripts.tar.xz).

{% highlight bash %}
{{download https://thomasweise.github.io/scripts/linux/findNonASCIIchars.sh}}
{% endhighlight %}
