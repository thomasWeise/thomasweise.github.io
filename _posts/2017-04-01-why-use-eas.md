...
use_math: true
---
[Some time ago](/posts/2017-01-26-global-vs-local-search), I discussed why global optimization with an Evolutionary Algorithm&nbsp;({% include taglink.liquid tag="EAs" tag_text="EA" %}) is not necessarily better than local search.
...
[Actually, it is often wrong](/posts/2017-01-26-global-vs-local-search).
